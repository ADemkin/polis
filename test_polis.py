...
class TestStringMethods(unittest.TestCase):
    ...
    def test_corpus_anton_october_2017(self):
        ...
        s = "Объект долевого строительства: однокомнатная квартира, корпус ББ/3-ГГ/3;2/3-3/3 с прим. к оси 4/3, номер этажа: 14, номер объекта: 137, проектная (планируемая) площадь: 25 кв.м, местоположение: г.Санкт-Петербург, Василеостровский район, Невская губа, уч.28, (западнее Васильевского острова, квартал 25);"
        res = impo.parseAddress(s)
        self.assertEqual(res[impo.CORPUS], '=""')  # ББ/3-ГГ/3;2/3-3/3
        self.assertEqual(res[impo.FLOOR], '14')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res[impo.CORPUS], '="2.3"')
    ...
    def test_podval_anton_october_2017(self):
        ...
        self.assertEqual(res[impo.FLOOR], '5')
        # meters
        s = "Объект долевого строительства: Нежилое помещение (Автостоянка), номер этажа: -5,950, номер объекта: 399-400, проектная (планируемая) площадь: 12955,24 кв.м, местоположение: г.Санкт-Петербург, Красносельский район, территория предприятия , уч.180, (Ленинские искры) Подземная автостоянка, строительные оси: 1а*-8а, А1а-М5а, 1/300 доля в праве общей долевой собственности;"
        res = impo.parseAddress(s)
        self.assertEqual(res[impo.FLOOR], '-5,950')
        s = "Объект долевого строительства: Нежилое помещение (Автостоянка), номер этажа: -5950, номер объекта: 3-4, проектная (планируемая) площадь: 12955,24 кв.м, местоположение: г.Санкт-Петербург, Красносельский район, территория предприятия , уч.180, (Ленинские искры), 1/300 доли,  в осях 1а*-8а; А1а-М5а.;"
        res = impo.parseAddress(s)
