...
class TestStringMethods(unittest.TestCase):
    ...
    def test_balkany(self):
        ...
        e = {'DduDocDesc_date': '14.11.2016',
             'DduDocDesc_number': "№134нп-БАЛ/12-15Г",
             'Type_dogovor': 'ДДУ'}
        ...
        e = {'DduDate': '04.02.2016',
             'DduDocDesc_date': '11.12.2015',
             'DduDocDesc_number': "№9Н-БАЛ/12-15Г",
             'Type_dogovor': 'Уступка'}
        self.assertEqual(impo.extractDduDocDesc(s), e)


    def test_generic(self):
        s = "Договор участия в долевом строительстве oт 28.01.2014 №5823/0114-М10"
        e = {'DduDocDesc_date': '28.01.2014',
             'DduDocDesc_number': "№5823/0114-М10",
             'Type_dogovor': 'ДДУ'}
        self.assertEqual(impo.extractDduDocDesc(s), e)
        s = "Договор №44458/0415-ТВ3 участия в долевом строительстве oт 08.04.2015"
        e = {'DduDocDesc_date': '08.04.2015',
             'DduDocDesc_number': "№44458/0415-ТВ3",
             'Type_dogovor': 'ДДУ'}
        self.assertEqual(impo.extractDduDocDesc(s), e)
        s = "Договор долевого участия oт 30.03.2017 №11382/0317-ТВ1"
        e = {'DduDocDesc_date': '30.03.2017',
             'DduDocDesc_number': "№11382/0317-ТВ1",
             'Type_dogovor': 'ДДУ'}
        self.assertEqual(impo.extractDduDocDesc(s), e)
        s = "Дополнительное соглашение oт 30.07.2014"
        res = impo.extractDduDocDesc(s)
        self.assertEqual(res['DduDocDesc_date'], "30.07.2014")
        self.assertEqual(res['DduDocDesc_number'], None)
        s = "Соглашение об уступке прав oт 20.04.2017"
        res = impo.extractDduDocDesc(s)
        self.assertEqual(res['DduDocDesc_date'], "20.04.2017")
        self.assertEqual(res['DduDocDesc_number'], None)
        ...
        res = impo.extractDduDocDesc(s)
        self.assertEqual(res['DduDocDesc_date'], "29.01.2016")
        self.assertEqual(res['DduDocDesc_number'], "№51790/0116-ТВ2")
        s = "Соглашение о замене стороны oт 12.05.2014"
        res = impo.extractDduDocDesc(s)
        self.assertEqual(res['DduDocDesc_date'], "12.05.2014")
        self.assertEqual(res['DduDocDesc_number'], None)
    ...
    def test_primorsky_2(self):
        ...
        e = {'DduDate': '15.06.2016',
             'DduDocDesc_date': '30.04.2016',
             'DduDocDesc_number': '№2.2/1/12/М',
             'Type_dogovor': 'Уступка'}
        self.assertEqual(impo.extractDduDocDesc(s), e)
    ...
    def test_romantic(self):
        ...
        e = {'DduDate': '14.10.2014',
             'DduDocDesc_date': '03.10.2014',
             'DduDocDesc_number': '№03/10/2014-ЯР-3-794',
             'Type_dogovor': 'Уступка'}
        self.assertEqual(impo.extractDduDocDesc(s), e)
        ...
        e = {'DduDate': '30.06.2015',
             'DduDocDesc_date': '03.04.2015',
             'DduDocDesc_number': '№44353/0415-ТВ2',
             'Type_dogovor': 'Уступка'}
        self.assertEqual(impo.extractDduDocDesc(s), e)
        ...
        res = impo.extractDduDocDesc(s)
        self.assertEqual('DduDate' not in res, True)
        ...
        res = impo.extractDduDocDesc(s)
        self.assertEqual(res['DduDocDesc_number'], "№42527/1214-ЮШ13")
        self.assertEqual(res['DduDocDesc_date'], "15.12.2014")
        ...
        res = impo.extractDduDocDesc(s)
        self.assertEqual(res['DduDocDesc_number'], "№03/12/2014-ЯР-3-538")
        self.assertEqual(res['DduDocDesc_date'], "03.12.2014")
        ...
        res = impo.extractDduDocDesc(s)
        self.assertEqual(res['DduDocDesc_number'], "№08/08/2015-ЯР-1-682")
        self.assertEqual(res['DduDocDesc_date'], "08.08.2015")
        ...
        res = impo.extractDduDocDesc(s)
        self.assertEqual(res['DduDocDesc_number'], "№14/04/2015-ЯР-2-719")
        self.assertEqual(res['DduDocDesc_date'], "14.04.2015")
        ...
        res = impo.extractDduDocDesc(s)
        self.assertEqual(res['DduDocDesc_number'], "№13/12/2016-ЯР-1-2-П-У")
        self.assertEqual(res['DduDocDesc_date'], "13.12.2016")
    ...
    def test_address(self):
        ...
        self.assertEqual(res['floor'], "9")
        self.assertEqual(res['object'], '="14-92Б"')
        self.assertEqual(res['corpus'], '="14"')
        self.assertEqual(res['address'], "г. Санкт-Петербург, Петроградский район, проспект Медиков, д.10, лит.Ж, корпус 14")
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['area'], "27,37")
        self.assertEqual(res['corpus'], '="3"')
        self.assertEqual(res['section'], '="1.1"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['area'], "24,29")
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['entrance'], "3")
        self.assertEqual(res['section'], '="2"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['address'], "город Санкт-Петербург, Петроградский район, проспект Медиков, д.10, лит.Ж, корпус 3")
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['area'], "65,6")
        s = "кта: 142Н, проектная (планируемая) площадь:3,97 кв.м, местоп"
        res = impo.parseAddress(s)
        self.assertEqual(res['area'], "3,97")
        s = "Объект долевого строительства: Двухкомнатная квартира, подъезд 1, номер этажа 12, номер объекта 17-122А, проектная (планируемая) площадь 65,6 кв.м., строительные оси: &quot;4-7; А-Г&quot;. Местоположение: город Санкт-Петербург, Петроградский район, проспект Медиков, д.10, лит.Ж, корпус 17."
        res = impo.parseAddress(s)
        self.assertEqual(res['object'], '="17-122А"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['object'], '="2738"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['object'], '="473"')
        self.assertEqual(res['floor'], "1")
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['type'], "нежилое помещение студия")
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['corpus'], '="13"')
        self.assertEqual(res['section'], '="1"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['entrance'], "2")
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['corpus'], '="15"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['rooms'], "студия")
    ...
    def test_floor(self):
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['floor'], "подвальный")
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['floor'], "подземный")
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['floor'], "-5,950")
    ...
    def test_transform_date_like_fields(self):
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['section'], '="6-6/4"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['section'], '="1-13"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['object'], '="7.5.24"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['object'], '="9.20"')
    ...
    def test_created_by_polina(self):
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['address'], "г.Санкт-Петербург, Василеостровский район, Невская губа, уч.28, (западнее Васильевского острова, квартал 25)")
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['corpus'], '="1"')
        self.assertEqual(res['section'], '="8"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['corpus'], '="1"')
        self.assertEqual(res['section'], '="3"')
        ...
        self.assertEqual(res['section'], '="4"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['corpus'], '="8"')
        self.assertEqual(res['entrance'], "1")
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['corpus'], '="2.1"')
        self.assertEqual(res['section'], '="2"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['corpus'], '="12"')
        self.assertEqual(res['section'], '="1"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['corpus'], '="7"')
        self.assertEqual(res['section'], '="5"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['corpus'], '="7"')
        self.assertEqual(res['section'], '="6"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['corpus'], '="1"')
        self.assertEqual(res['section'], '="7"')
        s = "Объект долевого строительства: Двухкомнатная квартира, номер этажа: 19, номер объекта: 186, проектная (планируемая) площадь: 63,2 кв.м, местоположение: г.Санкт-Петербург, Южное шоссе, уч.13, (юго-западнее дома 55, литера Д по Южному шоссе), пус -15, подъезд/секция -1, в осях 15с-19с, Ис-Эс."
        res = impo.parseAddress(s)
        self.assertEqual(res['corpus'], '="15"')
        self.assertEqual(res['section'], '="1"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['section'], '="1а"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['corpus'], '=""')
        self.assertEqual(res['section'], '="4"')
        self.assertEqual(res['entrance'], "4")
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['corpus'], '="25"')
        self.assertEqual(res['section'], '="1"')
        self.assertEqual(res['entrance'], "2")
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['section'], '="1-11"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['section'], '="19"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['corpus'], '="3.1"')
        self.assertEqual(res['section'], '="1"')
        self.assertEqual(res['entrance'], "2")
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['corpus'], '="3"')
        self.assertEqual(res['section'], '="1.2"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['section'], '="10"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['corpus'], '="3.1"')
        self.assertEqual(res['section'], '="2 (1)"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['section'], '="А, Б"')
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['entrance'], "5")
        ...
        res = impo.parseAddress(s)
        self.assertEqual(res['area'], "32,78")
        ...
        self.assertEqual(res['type_object'], 'машиноместо')
        ...
        # res = impo.parseAddress(s)
        # self.assertEqual(res['address'], "г.Санкт-Петербург, территория предприятия \"Предпортовый\", уч.180, (Ленинские искры),кад.No 78:40:0008501:3268")
        ...
        # res = impo.parseAddress(s)
        # self.assertEqual(res['address'], " г.Санкт-Петербург, улица Савушкина, уч.151, (квартал 66А Северо- Приморской части Приморского административного района),кад.No 78:34:0004163:23")
